...
int main() {
    ListaCircularDoble<Elemento> lista;
    ...
    // Buscar un elemento
    NodoCircularDoble<Elemento>* encontrado = lista.buscar(2);
    if (encontrado) {
    ...
    NodoCircularDoble<Elemento>* eliminado = lista.eliminar(Elemento(3, "Elemento 3"));
    if (eliminado) {
    ...
    NodoCircularDoble<Elemento>* eliminadoPos = lista.eliminarPosicion(1);
    if (eliminadoPos) {
